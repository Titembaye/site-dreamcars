    ...
    <div class="row profile-body">
        ...
        <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Changer le mot de pass</h6>
                        <form method="POST" action="{{route('admin.update.password')}}"  class="forms-sample" enctype="multipart/forl-data">
                        @csrf    
                        <div class="mb-3">
                            <label for="exempleInputEmail1" class="form-label">Ancien mot de pass</label>
                        ...
                        <div class="mb-3">
                            <label for="exempleInputEmail1" class="form-label">Nouveau mot de pass</label>
                        ...
                        <div class="mb-3">
                            <label for="exempleInputEmail1" class="form-label">Confirmer</label>
                            <input type="password" class="form-control @error('new_password_confirmation') is-invalid @enderror" id="new_password_confirmation" name="new_password_confirmation" autocomplete="off">
                        </div>
