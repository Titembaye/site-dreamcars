...
<div class="row voiture-section all_voitures" id="all_voitures">
    <div id="carrouselContainer" class="carousel-container">
        <div id="carrouselVoitures" class="carousel slide carrousel-responsive" data-bs-ride="carousel">
            <div class="carousel-inner">
              @foreach($voitures->chunk(9) as $key => $chunk)
  ...
  @foreach($voitures as $voiture)
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-lg-10 mx-auto">
                <a href="{{route('voiture.details' , ['voitureId' => $voiture->id])}}"> <img src="{{ asset('storage/' . $voiture->image) }}" class="img-fluid" alt="Véhicule principal"> </a>
                <div class="row mt-3">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
          // Initialiser le carrousel uniquement sur des écrans plus grands
          if (window.innerWidth >= 768) {
            new bootstrap.Carousel(document.getElementById('carrouselVoitures'));
          }
        });
      </script>
@endsection